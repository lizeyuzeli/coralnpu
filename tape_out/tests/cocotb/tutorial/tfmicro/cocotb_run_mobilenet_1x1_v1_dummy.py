...
async def core_mini_rvv_mobilenet_v1(dut):
    ...
    r = runfiles.Create()
    elf_files = ['run_mobilenet_1x1_v1_dummy_binary.elf']
    for elf_file in elf_files:
        await fixture.load_elf_and_lookup_symbols(
            r.Rlocation('coralnpu_hw/tape_out/tests/cocotb/tutorial/tfmicro/' + elf_file),
        ...
        cycle_count = await fixture.run_to_halt(timeout_cycles=130_000_000_0)
        ...
        print(f" \n Mobilenet v1 dummy Invoke() successful \n", flush=True)