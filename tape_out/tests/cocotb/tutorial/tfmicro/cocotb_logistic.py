...
class LogisticTester:
    def __init__(self, input_size):
        ...
        self.elf_file = r.Rlocation(
            "coralnpu_hw/tape_out/tests/cocotb/tutorial/tfmicro/logistic_test.elf"
        )
        self.fixture = None
    ...
    async def setup(self, dut):
        ...
        await self.fixture.run_to_halt(timeout_cycles=20_000_000)  # 20x for LVDS-bridged Core_Axi_Chip
    ...
    async def test(self, timeout_cycles=20_000_000):  # 20x for LVDS-bridged Core_Axi_Chip
