...
class FullyConnectedTester:
    def __init__(self, batches, input_depth, output_depth):
        ...
        self.elf_file = r.Rlocation(
            "coralnpu_hw/tape_out/tests/cocotb/tutorial/tfmicro/fully_connected_test.elf"
        )
        self.fixture = None
    ...
    async def test(self, timeout_cycles=100_000_000):  # 20x for LVDS-bridged Core_Axi_Chip
