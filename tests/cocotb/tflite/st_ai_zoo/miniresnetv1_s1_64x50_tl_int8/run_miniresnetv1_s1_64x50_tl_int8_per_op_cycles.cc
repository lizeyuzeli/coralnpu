...
// Per-op cycle profiling variant of the MiniResNet-V1 s1 64x50 INT8 runner.
//
...
constexpr int kInputElems = 1 * 64 * 50 * 1;
...
// model's op count (15 for this model); kTagBytes must match the matching
