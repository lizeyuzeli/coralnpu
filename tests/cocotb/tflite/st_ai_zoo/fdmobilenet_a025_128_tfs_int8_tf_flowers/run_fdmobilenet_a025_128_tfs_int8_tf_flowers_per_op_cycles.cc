...
// Per-op cycle profiling variant of the FD-MobileNet 0.25@128 INT8 runner.
//
...
// as a CSV under the bazel-managed test outputs dir.
...
constexpr int kInputElems = 1 * 128 * 128 * 3;
