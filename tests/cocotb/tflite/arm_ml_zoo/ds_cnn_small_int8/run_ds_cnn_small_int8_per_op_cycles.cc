...
// Per-op cycle profiling variant of the DS-CNN Small INT8 runner.
//
...
// model's op count; kTagBytes must match the matching constant in the cocotb
// side.
...
int main(int argc, char** argv) {
  ...
  const tflite::Model* model =
      tflite::GetModel(g_ds_cnn_s_quantized_model_data);
